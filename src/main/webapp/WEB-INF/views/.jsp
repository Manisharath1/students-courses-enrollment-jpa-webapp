...
<body style="background-color: #F0F3F4;">
	...
	<div class="container">
		...
		<div style="display: flex; justify-content: space-between;">
			...
			<a href="${pageContext.request.contextPath}/image-upload/home" class="signup-image-link">Go Home</a>
		</div>
			...
			<c:choose>
				<c:when test="${not empty employeeList}">
					...
					<c:forEach var="theEmployee" items="${employeeList}">
						...
						<tr>
							<td>${count}</td>
							<td><img src="/uploads/${theEmployee.fileName}" width="75" height="75" /></td>
							...
							<td><a
								href="${pageContext.request.contextPath}/image-upload/removeFile/${theEmployee.id}/${theEmployee.fileName}"
								onclick="return confirm('Are you sure you want to delete ${theEmployee.name}?');">Delete</a>
							</td>
						</tr>
					</c:forEach>
				</c:when>
